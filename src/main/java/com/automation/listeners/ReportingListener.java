...
public class ReportingListener implements ITestListener, ISuiteListener, IInvokedMethodListener {
	...
	public void onStart(ISuite arg0) {
		...
		extent = new ExtentReports("api_execution_report.html", true); //Provide Desired Report Directory Location and Name
		extent.loadConfig(new File("src\\main\\resources\\extent.xml")); //Supporting File for Extent Reporting
	...
	private void printTestResults(ITestResult result) {
		...
		case ITestResult.SKIP:
			...
			status = "Skipped";
			test.log(LogStatus.SKIP, "Step details");
	...
	public void beforeInvocation(IInvokedMethod method, ITestResult arg1) {
		...
		test = extent.startTest((this.getClass().getSimpleName() +" :: "+  method.getTestMethod().getMethodName()),method.getTestMethod().getMethodName()); //Test Case Start Here
